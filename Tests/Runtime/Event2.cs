...
{
    public class Given {
        protected Event2 Event { get; private set; }
    ...
    public class When_ListenerRegistered : Given {
        public override void SetUp() {
            ...
            Event.Register(Substitute.For<IListener<int, int>>());
        }
...
namespace Given_Event2.Given_ThreeListenersRegistered
{
    public class Given : Given_Event2.Given
    {
        protected IListener<int, int> listener0 { get; private set; }
        protected IListener<int, int> listener1 { get; private set; }
        protected IListener<int, int> listener2 { get; private set; }
    ...
    public class When_Raised : Given
    {
        ...
        public void Then_OnlyTheTwoRegisteredListenersGetCalled() {
            ...
            listener1.DidNotReceive().OnEventRaised(0, 1);
